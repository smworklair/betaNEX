  ...
  return (
    <div className="fade content-narrow">
      ...
      <AiBox
        ...
        page="schedule"
        facts={[
          'Пн: лекция БД 9:00, свободное окно 12:00 (ауд. 305)',
          'Вт: совет кафедры 10:30',
          'Ср: экзамен ПИ-21-1 9:00',
          'Чт: дедлайн приказов 15:00',
          'Пт: карьерная ярмарка 11:00',
        ]}
        fallback={(q) => `На неделе плотно: экзамен в среду и дедлайн приказов в четверг. Свободный слот — Пн 12:00 (ауд. 305): туда логично вписать консультацию или подготовку к экзамену. Запрос «${q}» обработаю живой моделью после подключения ai-gateway.`}
      />
      <div className="card">
  ...
  return (
    <div className="fade content-narrow">
      ...
      <AiBox
        ...
        page="cloud"
        facts={[
          'Папки: «Учебные планы 2024», «Приказы»',
          'Файлы: «Отчёт_посещаемость_июнь.xlsx», «Презентация_приёмная_кампания.pdf», «Договор_ВК_стажировка.docx», «backup_бд_ночной.zip»',
        ]}
        fallback={(q) => `По запросу «${q}»: похоже, вам нужен «Договор_ВК_стажировка.docx» или «Отчёт_посещаемость_июнь.xlsx». Полноценный поиск и суммаризация — после подключения ai-gateway в Настройках.`}
      />
